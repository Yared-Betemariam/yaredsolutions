...
const HeroSection = () => {
  return (
    <section className="relative  overflow-hidden bg-gradient-to-br from-primary/5 to-red-500/10 border-b border-primary/20">
      ...
      />
      <section className="wrapper placeholder:flex flex-col gap-12 md:gap-20 md:flex-row py-16 pt-20 items-center justify-center relative">
        ...
        <div className="flex flex-col pt-14 pb-4 gap-10  items-center justify-center text-center">
          {/* <p className="bg-white opacity-90 border-[1.5px] border-primary/90 text-primary/90 rounded-full px-5 py-1.5 font-semibold">
          ...
          <div className="flex items-center">
            <h1
              className={fontWrapper(
                "leading-[3.1rem] text-5xl sm:text-7xl tracking-tight lg:text-8xl font-extrabold drop-shadow-md uppercase"
              )}
            >
              web developer
            </h1>
          ...
          <a href={"#contact"} className="">
            <Button
              size={"lg"}
              variant={"secondary"}
              className="font-semibold text-white textwhite text-lg bg-primary/85 h-14 px-8 shadow-md hover:bg-primary/70 duration-300 transition-all rounded-full space-x-4"
            >
