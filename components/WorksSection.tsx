...
const WorksSection = () => {
  return (
    <section id="works" className="wrapper flex flex-col relative">
      <span className="bg-circle bg-no-repeat top-[10rem] right-[20rem] opacity-20 absolute w-[40rem] -z-10 h-[40rem] bg-contain bg-center" />
      <div className="flex flex-col py-16 gap-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 mx-auto gap-6 w-full max-w-4xl">
          {works.map((item) => (
